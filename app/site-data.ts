...
export const COMPARISON_ROWS: readonly ComparisonRow[] = [
  ...
  { label: "SEO para productos y categorías", values: [false, false, "Hasta 20 productos", "Hasta 30 productos", "Hasta 50 productos"] },
  ...
  { label: "Google Search Console", values: [false, false, true, true, true] },
  ...
  { label: "Investigación inicial de palabras clave", values: [false, false, false, false, true] },
  { label: "Reporte SEO inicial", values: [false, false, false, false, true] },
